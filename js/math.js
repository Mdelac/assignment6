...
//var userNumber = window.prompt("Type a Number");
//window.alert(Math.abs(userNumber));
...
//var userNumber = window.prompt("Type a Decinmal Number");
//window.alert(Math.ceil(userNumber));
...
//var userNumber = window.prompt("Type a Decinmal Number");
//window.alert(Math.floor(userNumber));
...
/*var userNumber = window.prompt("Please enter 5 numbers separated by commas");
